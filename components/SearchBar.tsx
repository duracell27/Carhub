...
const SearchBar = () => {
  ...
  const handleSearch = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (manufacturer === "" && model === "") {
      return alert("Please fill the manufacturer or model");
    }

    updateSearchParans(model.toLowerCase(), manufacturer.toLowerCase());
  };

  const updateSearchParans = (model: string, manufacturer: string) => {
